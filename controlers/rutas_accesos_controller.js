...
const quitar_permiso_a_usuario = async ( req = request, res = response )=>{
    ...
    try {
        ...
        const nuevo_permiso = await prisma.rutas_habilitadas_rol.delete( { 
                                                                            data : {
...
module.exports = { agregar_permiso_a_usuario, obtener_rutas_aplicacion, obtener_rutas_de_usuario }