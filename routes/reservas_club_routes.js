...
router_reservas_club.get( '/obtener_reservas_club', [ ], obtener_reservas_en_club );

router_reservas_club.post( '/crear_reserva_club', [ comprobar_disponibilidad_reserva ], crear_reserva_en_club );

router_reservas_club.delete( '/borrar_reserva_club/:id', [ ], borrar_reserva_en_club );

router_reservas_club.put( '/editar_reserva_club/:id', [ ], editar_reserva_en_club );
