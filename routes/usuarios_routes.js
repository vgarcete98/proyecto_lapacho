...
const { validar_existe_usuario, comprobar_usuario_valido }= require( '../middlewares/validar_existe_usuario' );
...
router_usuario.delete( '/:id_usuario',[ validar_token, validar_rol_usuario, comprobar_usuario_valido ], borrar_usuario );
